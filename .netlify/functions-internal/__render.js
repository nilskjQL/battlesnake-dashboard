...
// node_modules/.pnpm/@sveltejs+kit@1.0.0-next.199_svelte@3.44.2/node_modules/@sveltejs/kit/dist/install-fetch.js
...
// .svelte-kit/output/server/chunks/__layout-75022135.js
var layout_75022135_exports = {};
__export(layout_75022135_exports, {
  default: () => _layout
});
var _layout;
var init_layout_75022135 = __esm({
  ".svelte-kit/output/server/chunks/__layout-75022135.js"() {
    init_shims();
    init_app_e6bc3a02();
    _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"bg-gray-900 h-full"}">${slots.default ? slots.default({}) : ``}</div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/error-63a6c51d.js
var error_63a6c51d_exports = {};
__export(error_63a6c51d_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/index-accfdb08.js
var index_accfdb08_exports = {};
__export(index_accfdb08_exports, {
  default: () => Routes
});
var Routes;
var init_index_accfdb08 = __esm({
  ".svelte-kit/output/server/chunks/index-accfdb08.js"() {
    init_shims();
    init_app_e6bc3a02();
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<main class="${"text-white"}"><h1>QL Battlesnake night</h1>
	<p>Instructions and rules</p></main>`;
    });
  }
});

// node_modules/.pnpm/datocms-listen@0.1.6/node_modules/datocms-listen/dist/subscribeToQuery/index.js
var require_subscribeToQuery = __commonJS({
  "node_modules/.pnpm/datocms-listen@0.1.6/node_modules/datocms-listen/dist/subscribeToQuery/index.js"(exports) {
    init_shims();
    "use strict";
    ...
    var Response500Error = function(_super) {
      __extends(Response500Error2, _super);
      function Response500Error2(message) {
        var _this = _super.call(this, message) || this;
        Object.setPrototypeOf(_this, Response500Error2.prototype);
        return _this;
      }
      return Response500Error2;
    }(Error);
    var Response400Error = function(_super) {
      __extends(Response400Error2, _super);
      function Response400Error2(message) {
        var _this = _super.call(this, message) || this;
        Object.setPrototypeOf(_this, Response400Error2.prototype);
        return _this;
      }
      return Response400Error2;
    }(Error);
    var InvalidResponseError = function(_super) {
      __extends(InvalidResponseError2, _super);
      function InvalidResponseError2(message) {
        var _this = _super.call(this, message) || this;
        Object.setPrototypeOf(_this, InvalidResponseError2.prototype);
        return _this;
      }
      return InvalidResponseError2;
    }(Error);
    function subscribeToQuery(options2) {
      return __awaiter(this, void 0, void 0, function() {
        var query, token, variables, preview, environment, customFetcher, customEventSourceClass, onStatusChange, onUpdate, onChannelError, customReconnectionPeriod, customBaseUrl, fetcher, EventSourceClass, reconnectionPeriod, baseUrl, waitAndReconnect, channelUrl, req, registration, e_1;
        var _this = this;
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              query = options2.query, token = options2.token, variables = options2.variables, preview = options2.preview, environment = options2.environment, customFetcher = options2.fetcher, customEventSourceClass = options2.eventSourceClass, onStatusChange = options2.onStatusChange, onUpdate = options2.onUpdate, onChannelError = options2.onChannelError, customReconnectionPeriod = options2.reconnectionPeriod, customBaseUrl = options2.baseUrl;
              fetcher = customFetcher || window.fetch;
              EventSourceClass = customEventSourceClass || window.EventSource;
              reconnectionPeriod = Math.min(customReconnectionPeriod || 1e3, 2e4);
              baseUrl = customBaseUrl || "https://graphql-listen.datocms.com";
              waitAndReconnect = function() {
                return __awaiter(_this, void 0, void 0, function() {
                  return __generator(this, function(_a2) {
                    switch (_a2.label) {
                      case 0:
                        return [4, new Promise(function(resolve2) {
                          return setTimeout(resolve2, reconnectionPeriod);
                        })];
                      case 1:
                        _a2.sent();
                        return [2, subscribeToQuery(__assign(__assign({}, options2), { reconnectionPeriod: reconnectionPeriod * 2 * (1 + (Math.random() * 0.2 - 0.1)) }))];
                    }
                  });
                });
              };
            ...
            case 1:
              _a.trys.push([1, 4, , 5]);
              return [4, fetcher(endpointFactory({ baseUrl, preview, environment }), {
                headers: {
            ...
            case 4:
              e_1 = _a.sent();
              if (e_1 instanceof Response400Error || e_1 instanceof InvalidResponseError) {
                throw e_1;
              }
              console.info("Failed to get a channelUrl, retrying...", e_1);
              return [2, waitAndReconnect()];
            case 5:
...
// node_modules/.pnpm/datocms-listen@0.1.6/node_modules/datocms-listen/dist/index.js
var require_dist = __commonJS({
  "node_modules/.pnpm/datocms-listen@0.1.6/node_modules/datocms-listen/dist/index.js"(exports) {
    init_shims();
    "use strict";
    ...
    exports.__esModule = true;
    __export2(require_subscribeToQuery());
  }
});
...
var init_instanceOf = __esm({
  "node_modules/graphql/jsutils/instanceOf.mjs"() {
    init_shims();
    init_inspect();
    instanceOf_default = process.env.NODE_ENV === "production" ? function instanceOf(value, constructor) {
...
function uniCharCode(a2, b, c2, d) {
  return char2hex(a2) << 12 | char2hex(b) << 8 | char2hex(c2) << 4 | char2hex(d);
}
...
// node_modules/.pnpm/wonka@4.0.15/node_modules/wonka/dist/wonka.mjs
function l(a2, b) {
  b.tag = a2;
  return b;
}
...
function p(a2) {
  return function(b) {
    var c2 = a2.length;
    let d = false, e = false, f2 = false, g = 0;
    b(l(0, [
      function(h2) {
        if (h2) {
          d = true;
          ...
          for (e = f2 = true; f2 && !d; ) {
            g < c2 ? (h2 = a2[g], g = g + 1 | 0, f2 = false, b(l(1, [h2]))) : (d = true, b(0));
          }
          e = false;
        }
      }
...
function D(a2) {
  return function(b) {
    return function(c2) {
      ...
      b(function(b2) {
        typeof b2 == "number" ? h2 || (h2 = true, g.length === 0 && c2(0)) : b2.tag ? h2 || (f2 = false, function(a3) {
          function b3(a4) {
            typeof a4 == "number" ? g.length !== 0 && (g = g.filter(d), a4 = g.length === 0, h2 && a4 ? c2(0) : !f2 && a4 && (f2 = true, e(0))) : a4.tag ? g.length !== 0 && (c2(l(1, [a4[0]])), k(0)) : (k = a4 = a4[0], g = g.concat(a4), a4(0));
          }
          function d(a4) {
            return a4 !== k;
          }
...
function K(a2) {
  return function(b) {
    return function(c2) {
      function d(a3) {
        h2 && (typeof a3 == "number" ? (h2 = false, n ? c2(a3) : f2 || (f2 = true, e(0))) : a3.tag ? (c2(a3), k ? k = false : g(0)) : (g = a3 = a3[0], k = false, a3(0)));
      }
      let e = m, f2 = false, g = m, h2 = false, k = false, n = false;
      b(function(b2) {
        typeof b2 == "number" ? n || (n = true, h2 || c2(0)) : b2.tag ? n || (h2 && (g(1), g = m), f2 ? f2 = false : (f2 = true, e(0)), b2 = a2(b2[0]), h2 = true, b2(d)) : e = b2[0];
      });
      c2(l(0, [
        function(a3) {
          if (a3) {
  ...
  return function(b) {
    return function(c2) {
      ...
      return b(function(b2) {
        typeof b2 == "number" ? p(d)(c2) : b2.tag ? (d.length >= a2 && 0 < a2 && d.shift(), d.push(b2[0]), e(0)) : (b2 = b2[0], 0 >= a2 ? (b2(1), u(c2)) : (e = b2, b2(0)));
      });
    };
  };
}
...
function fromValue$1(a2) {
  return function(b) {
    ...
    b(l(0, [
      function(d) {
        d ? c2 = true : c2 || (c2 = true, b(l(1, [a2])), b(0));
      }
    ]));
  };
}
...
function takeUntil$1(a2) {
  return function(b) {
    return function(c2) {
      function d(a3) {
        typeof a3 != "number" && (a3.tag ? (e = true, f2(1), c2(0)) : (g = a3 = a3[0], a3(0)));
      }
      let e = false, f2 = m, g = m;
      b(function(b2) {
        typeof b2 == "number" ? e || (e = true, g(1), c2(0)) : b2.tag ? e || c2(b2) : (f2 = b2[0], a2(d));
      });
      c2(l(0, [
        function(a3) {
          if (!e) {
...
// node_modules/.pnpm/@urql+core@2.3.5/node_modules/@urql/core/dist/01e1547d.mjs
...
function mergeResultPatch(e, r2, t2) {
  ...
  while (i2 < r2.path.length) {
    o = o[s3 = r2.path[i2++]] = Array.isArray(o[s3]) ? [].concat(o[s3]) : _extends({}, o[s3]);
  }
  _extends(o, r2.data);
  return n;
}
...
function executeIncrementalFetch(e, r2, t2) {
  ...
  return i2().then(function next(n2) {
    if (!n2.done) {
      ...
      p2 += a3;
      while (s4 > -1) {
        var u4 = p2.slice(0, s4);
        var f2 = p2.slice(s4 + o.length);
        if (d) {
          d = false;
        } else {
          var h2 = u4.indexOf("\r\n\r\n") + 4;
          var g = u4.slice(0, h2);
          var y = u4.slice(h2, u4.lastIndexOf("\r\n"));
          var x = void 0;
          if (l2.test(g)) {
            try {
              x = JSON.parse(y);
              m2 = v = v ? mergeResultPatch(v, x, t2) : makeResult(r2, x, t2);
            } catch (e2) {
            }
          }
          if (f2.slice(0, 2) === "--" || x && !x.hasNext) {
            if (!v) {
...
var init_e1547d = __esm({
  "node_modules/.pnpm/@urql+core@2.3.5/node_modules/@urql/core/dist/01e1547d.mjs"() {
    ...
    s = new WeakMap();
    u2 = new Map();
    f = typeof Symbol != "undefined" ? Symbol.asyncIterator : null;
...
// node_modules/.pnpm/@urql+core@2.3.5/node_modules/@urql/core/dist/urql-core.mjs
  ...
  for (var a2 = 0; a2 < t2.length; a2++) {
    if (t2[a2].kind === Kind.FRAGMENT_DEFINITION) {
      ...
      if (!e.has(o)) {
        e.set(o, i2);
        n.push(t2[a2]);
      } else if (process.env.NODE_ENV !== "production" && e.get(o) !== i2) {
...
// .svelte-kit/output/server/chunks/index-ca5736cd.js
var index_ca5736cd_exports = {};
__export(index_ca5736cd_exports, {
  default: () => Leaderboard
});
var import_datocms_listen, DatoToken, DatoBaseUrl, fetchOptions, css, Leaderboard;
var init_index_ca5736cd = __esm({
  ".svelte-kit/output/server/chunks/index-ca5736cd.js"() {
    init_shims();
    init_app_e6bc3a02();
    import_datocms_listen = __toModule(require_dist());
    init_urql_core();
    DatoToken = "36bc07796aff3b24cc723b22a8c179";
    DatoBaseUrl = "https://graphql.datocms.com";
    fetchOptions = () => {
...
`;
    css = {
      code: "dl.svelte-1yin344{display:grid;gap:1.5rem;grid-template-columns:-webkit-max-content auto;grid-template-columns:max-content auto}dl.svelte-1yin344,dt.svelte-1yin344{font-size:1.25rem;line-height:1.75rem}dt.svelte-1yin344{grid-column-start:1}dd.svelte-1yin344{font-size:1.25rem;grid-column-start:2;line-height:1.75rem}",
      map: null
    };
    Leaderboard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let subscription = { data: void 0 };
      let unsubscribe;
      onDestroy(() => unsubscribe?.());
      $$result.css.add(css);
      return `<main class="${"flex flex-col md:flex-row w-full justify-center gap-x-8"}"><aside class="${"w-full md:max-w-xl mx-auto md:px-0 px-6 md:flex-1"}"><h1 class="${"py-8 ml-4 text-center text-white text-2xl"}">QL Battlesnake Leaderboard \u{1F40D}</h1>
		${``}</aside>
	<aside class="${"text-white md:flex-1 max-w-2xl"}"><h1 class="${"py-8 ml-4 text-center text-white text-2xl"}">Previous round ${escape(subscription.data?.dashboard?.round)}</h1>
		<div class="${"grid place-items-center"}"><img src="${"../../../static/giftest.gif"}"></div>
		<h2 class="${"pt-8 text-2xl"}">Results</h2>
		<dl class="${"pt-4 svelte-1yin344"}"><dt class="${"svelte-1yin344"}">Winner \u{1F3C6}</dt><dd class="${"svelte-1yin344"}">${escape(subscription.data?.dashboard?.winner?.name)}</dd><dt class="${"svelte-1yin344"}">Runner up \u{1F948}</dt><dd class="${"svelte-1yin344"}">${escape(subscription.data?.dashboard?.secondPlace?.name)}</dd><dt class="${"svelte-1yin344"}">Third place \u{1F949}</dt><dd class="${"svelte-1yin344"}">${escape(subscription.data?.dashboard?.thirdPlace?.name)}</dd><dt class="${"svelte-1yin344"}">Sympathy points \u{1F602}</dt><dd class="${"svelte-1yin344"}">${escape(subscription.data?.dashboard?.sympathy?.name)}</dd></dl>

		<h3 class="${"pt-12 text-2xl"}">Announcement \u{1F4E3}</h3>
		<p class="${"pt-4 pb-20"}">${escape(subscription.data?.dashboard?.info)}</p></aside>
</main>`;
    });
  }
});

// .svelte-kit/output/server/chunks/app-e6bc3a02.js
...
function hash2(value) {
  ...
  if (typeof value === "string") {
    while (i2)
      hash22 = hash22 * 33 ^ value.charCodeAt(--i2);
  } else {
    while (i2)
      hash22 = hash22 * 33 ^ value[--i2];
  }
...
async function render_response({
  ...
  const body = options2.amp ? rendered.html : `${rendered.html}
    ...
    if (body2)
      attributes += ` data-body="${hash2(body2)}"`;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-d03c0fbb.js",
      css: [assets + "/_app/assets/start-464e9d0a.css"],
      js: [assets + "/_app/start-d03c0fbb.js", assets + "/_app/chunks/vendor-1bfcc4b1.js"]
    },
    fetched: void 0,
    floc: false,
...
var __accessCheck, __privateGet, __privateAdd, __privateSet, _map, chars, unsafeChars, reserved, escaped$1, objectProtoOwnPropertyNames, subscriber_queue, escape_json_string_in_html_dict, escape_html_attr_dict, s$1, s2, absolute, ReadOnlyFormData, current_component, escaped, missing_component, on_destroy, css2, Root, base, assets, user_hooks, template, options, default_settings, empty, manifest, get_hooks, module_lookup, metadata_lookup;
var init_app_e6bc3a02 = __esm({
  ".svelte-kit/output/server/chunks/app-e6bc3a02.js"() {
    init_shims();
...
${``}`;
    ...
    empty = () => ({});
    manifest = {
      assets: [{ "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "giftest.gif", "size": 1442037, "type": "image/gif" }],
      ...
      routes: [
        ...
        },
        {
          ...
          pattern: /^\/leaderboard\/?$/,
          params: empty,
          a: ["src/routes/__layout.svelte", "src/routes/leaderboard/index.svelte"],
          b: [".svelte-kit/build/components/error.svelte"]
        }
      ]
    };
    ...
    module_lookup = {
      "src/routes/__layout.svelte": () => Promise.resolve().then(() => (init_layout_75022135(), layout_75022135_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_63a6c51d(), error_63a6c51d_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_accfdb08(), index_accfdb08_exports)),
      "src/routes/leaderboard/index.svelte": () => Promise.resolve().then(() => (init_index_ca5736cd(), index_ca5736cd_exports))
    };
    metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-68a01aba.js", "css": ["assets/pages/__layout.svelte-ba6d88ee.css"], "js": ["pages/__layout.svelte-68a01aba.js", "chunks/vendor-1bfcc4b1.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-ffeedc87.js", "css": [], "js": ["error.svelte-ffeedc87.js", "chunks/vendor-1bfcc4b1.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-29f285e0.js", "css": [], "js": ["pages/index.svelte-29f285e0.js", "chunks/vendor-1bfcc4b1.js"], "styles": [] }, "src/routes/leaderboard/index.svelte": { "entry": "pages/leaderboard/index.svelte-e772d067.js", "css": ["assets/pages/leaderboard/index.svelte-55bf43c9.css"], "js": ["pages/leaderboard/index.svelte-e772d067.js", "chunks/vendor-1bfcc4b1.js"], "styles": [] } };
  }
});
